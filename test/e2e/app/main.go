...
// startApp starts the application server, listening for connections from Tenderxazab.
...
// startNode starts a Tenderxazab node running the application directly. It assumes the Tenderxazab
// configuration is in $TMHOME/config/tenderxazab.toml.
//
...
// startMaverick starts a Maverick node that runs the application directly. It assumes the Tenderxazab
// configuration is in $TMHOME/config/tenderxazab.toml.
